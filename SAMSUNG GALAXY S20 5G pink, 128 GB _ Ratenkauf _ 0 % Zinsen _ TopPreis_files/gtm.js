...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_eventLabel":["template","Scroll ",["macro",5],"%"],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      "vtp_enableFirebaseCampaignData":true,
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",3],
      "vtp_eventAction":["template",["macro",8],["macro",9]],
      ...
      "vtp_uniqueTriggerId":"11498909_10",
      ...
      "vtp_uniqueTriggerId":"11498909_17",
      "tag_id":8
    }],
  "predicates":[{
      "function":"_eq",
      ...
      "function":"_eq",
      "arg0":["macro",2],
      "arg1":"\/checkout\/bestellbestaetigung"
    },{
      "function":"_eq",
      "arg0":["macro",0],
...
function Tc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.o[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Vc={},Wc=null,Xc=Math.random();Vc.s="GTM-5FQXHHQ";Vc.Cb="3i0";var Yc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Zc="www.googletagmanager.com/gtm.js";var ad=Zc,bd=null,cd=null,dd=null,ed="//www.googletagmanager.com/a?id="+Vc.s+"&cv=21",fd={},gd={},hd=function(){var a=Wc.sequence||0;Wc.sequence=a+1;return a};var id={},jd=function(a,b){id[a]=id[a]||[];id[a][b]=!0},kd=function(a){for(var b=[],c=id[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
d.vtp_trackType){x("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");var V=function(O){return U("transaction"+O,1)},ca=V("Id");x("ecommerce:addTransaction",{id:ca,affiliation:V("Affiliation"),revenue:V("Total"),shipping:V("Shipping"),tax:V("Tax")});for(var da=V("Products")||[],M=0;M<da.length;M++){var N=da[M];x("ecommerce:addItem",{id:ca,sku:N.sku,name:N.name,category:N.category,price:N.price,quantity:N.quantity})}x("ecommerce:send");
